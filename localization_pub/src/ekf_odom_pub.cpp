...
const double TICKS_PER_REVOLUTION = 960; // For reference purposes.
const double WHEEL_RADIUS = 0.034; // Wheel radius in meters
const double WHEEL_BASE = 0.201; // Center of left tire to center of right tire
const double TICKS_PER_METER = 4492; // Original was 2800
...
// Get initial_2d message from either Rviz or a manual pose publisher
